...
[_COLE_MAC] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,   KC_V,   KC_ENT,      _______, KC_K,  KC_H, KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                    _______, _______, TT(_NAV_MAC), SFT_T(KC_SPC), SFT_T(KC_BSPC), LT(_SYM,KC_DEL), _______, _______
),
[_NAV_MAC] = LAYOUT(
